...
assign total_16_coulmn_window = ((reg_ifmap_h - 16) / 14)+1; 
        ...
        if (request == 2'b01) begin // first window
            ...
            case (counter)
                ...
                3 : begin
                    ...
                    else if((coulmn_ptr_ifmap_h >= total_16_coulmn_window) && (row_ptr_ifmap_w >= (reg_ifmap_w-1))) begin
        ...
        endcase
            ...
            3 : begin
                ...
                // Check if we reached or passed the last address of the current vertical slice
                    if(row_ptr_ifmap_w >= (reg_ifmap_w - 2) ) begin
                        flag <= 1;
                        normal_ptr <= (coulmn_ptr_ifmap_h + 1) * reg_ifmap_w;
                        row_ptr_ifmap_w <= 0;
                        valid_add <= 1;
